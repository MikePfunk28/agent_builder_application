...
export const MODEL_CATALOG: ModelMetadata[] = [
  ...
  // Moonshot (Bedrock)
  {
    ...
    description: "Moonshot K2.5 — best price-performance reasoning with 300 sequential tool calls.",
    provider: "bedrock",
    family: "Moonshot",
    contextLength: 128000,
    defaultConfig: {
  ...
  // MiniMax (Bedrock)
  {
    ...
    label: "MiniMax M2.1",
    description: "Autonomous coding with massive output window — 65K token output on Bedrock.",
    provider: "bedrock",
    family: "MiniMax",
  ...
  // Zhipu GLM (Bedrock)
  {
    ...
    label: "GLM 4.7",
    description: "Zhipu frontier reasoning and coding model on Bedrock.",
    provider: "bedrock",
    family: "Zhipu GLM",
    contextLength: 128000,
    defaultConfig: {
  ...
  },
  {
    ...
    label: "GLM 4.7 Flash",
    description: "Lightweight GLM model for cost-efficient production workloads.",
    provider: "bedrock",
    family: "Zhipu GLM",
    contextLength: 128000,
    defaultConfig: {
  ...
  // Qwen (Bedrock)
  {
    ...
    description: "Alibaba agentic coding specialist (MoE 480B, 35B active) on Bedrock.",
    provider: "bedrock",
    family: "Qwen",
